 ...
 */
export function findTeammateTaskByAgentId(agentId: string, tasks: Record<string, TaskStateBase | any>): InProcessTeammateTaskState | undefined {
 ...
 */
export function getAllInProcessTeammateTasks(tasks: Record<string, TaskStateBase | any>): InProcessTeammateTaskState[] {
 ...
 */
export function getRunningTeammatesSorted(tasks: Record<string, TaskStateBase | any>): InProcessTeammateTaskState[] {
