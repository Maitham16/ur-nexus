...
/**
 * Loads markdown files from .ur/output-styles directories throughout the project
 * and from ~/.ur/output-styles directory and converts them to output styles.
 *
 ...
 *
 * Structure:
 * - Project .ur/output-styles/*.md -> project styles
 * - User ~/.ur/output-styles/*.md -> user styles (overridden by project styles)
 *
