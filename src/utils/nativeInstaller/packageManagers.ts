/**
 * Package manager detection for UR CLI
 */
...
/**
 * Detects if the currently running UR instance was installed via mise
...
/**
 * Detects if the currently running UR instance was installed via asdf
...
/**
 * Detects if the currently running UR instance was installed via Homebrew
 ...
 * - Homebrew cask: /opt/homebrew/Caskroom/ur/...
 * - npm-global (via Homebrew's npm): /opt/homebrew/lib/node_modules/@urhq-ai/...
 */
...
/**
 * Detects if the currently running UR instance was installed via winget
...
/**
 * Detects if the currently running UR instance was installed via pacman
...
/**
 * Detects if the currently running UR instance was installed via a .deb package
...
/**
 * Detects if the currently running UR instance was installed via an RPM package
...
/**
 * Detects if the currently running UR instance was installed via Alpine APK
...
/**
 * Memoized function to detect which package manager installed UR
