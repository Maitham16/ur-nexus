...
async function runSpecVerification(cwd, name, options = {}) {
  if (options.kernel) {
    const { runSpecVerifyWithKernel } = await import("./kernelSpec-esezbyt2.js");
  ...
  const { readPhase: readPhase2, loadSpec: loadSpec2, parseTasks: parseTasks2 } = await import("./spec-ksa6eaj1.js");
