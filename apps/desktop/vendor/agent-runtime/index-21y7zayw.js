...
`;
    ...
    static async#getProxyAgent() {
      this.#proxyAgent ||= (await import("./index-ksm3z8v7.js").then((m)=>__toESM(m.default))).HttpsProxyAgent;
      return this.#proxyAgent;
    }
    static async#getFetch() {
      const hasWindow = typeof window !== "undefined" && !!window;
      this.#fetch ||= hasWindow ? window.fetch : (await import("./index-7a3prhjk.js")).default;
      return this.#fetch;
    }
