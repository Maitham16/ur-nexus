...
async function runSpecVerification(cwd, name, options = {}) {
  if (options.kernel) {
    const { runSpecVerifyWithKernel } = await import("./kernelSpec-fsdps1j9.js");
  ...
  const { readPhase: readPhase2, loadSpec: loadSpec2, parseTasks: parseTasks2 } = await import("./spec-2gx5pyj9.js");
