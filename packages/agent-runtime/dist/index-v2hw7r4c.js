...
function getSteps() {
  const hasAgentMd = getFsImplementation().existsSync(join(getCwd(), "UR.md"));
  const isWorkspaceDirEmpty = isDirEmpty(getCwd());
  return [
    {
      key: "workspace",
      text: "Ask UR to create a new app or clone a repository",
      isComplete: false,
      isCompletable: true,
    ...
    {
      key: "agentmd",
      text: "Run /init to create a UR.md file with instructions for UR",
...
export { maybeMarkProjectOnboardingComplete, shouldShowProjectOnboarding, incrementProjectOnboardingSeenCount, init_projectOnboardingState, getNativeCSIuTerminalDisplayName, shouldOfferTerminalSetup, setupTerminal, isShiftEnterKeyBindingInstalled, hasUsedBackslashReturn, markBackslashReturnUsed, call, init_terminalSetup };
