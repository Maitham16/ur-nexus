...
function getSwarmSocketName() {
  return `ur-swarm-${process.pid}`;
}
var TEAM_LEAD_NAME = "team-lead", SWARM_SESSION_NAME = "ur-swarm", SWARM_VIEW_WINDOW_NAME = "swarm-view", TMUX_COMMAND = "tmux", HIDDEN_SESSION_NAME = "ur-hidden", TEAMMATE_COMMAND_ENV_VAR = "UR_CODE_TEAMMATE_COMMAND";
var init_constants = () => {};
...
export { TEAM_LEAD_NAME, SWARM_SESSION_NAME, SWARM_VIEW_WINDOW_NAME, TMUX_COMMAND, HIDDEN_SESSION_NAME, getSwarmSocketName, TEAMMATE_COMMAND_ENV_VAR, init_constants, isInsideTmuxSync, isInsideTmux, getLeaderPaneId, isTmuxAvailable, isInITerm2, IT2_COMMAND, isIt2CliAvailable, resetDetectionCache, init_detection };
